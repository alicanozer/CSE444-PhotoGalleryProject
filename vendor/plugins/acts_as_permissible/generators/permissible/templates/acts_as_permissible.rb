    ...
    module Permissible #:nodoc:
      ...
      module ClassMethods
        def acts_as_permissible
          ...
          has_many
          :<%= role_membership_model_file_name.pluralize %>, :as => : roleable, :dependent => :destroy
      ...
      module InstanceMethods
        ...
        def permissions_hash
          @permissions_hash ||= lambda do
            ...
            <% unless options[:skip_roles] -%><%= role_model_file_name %>s.each do |
